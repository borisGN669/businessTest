	...
	public static function ajaxpage_spinner()
	{
		...
		<div class="ajax-page-load-indicator" style="display:none">
			<div class="text-center d-flex justify-content-center load-indicator">
				...
				<span class="font-weight-bold">Chargement...</span>
			</div>
		</div>
		<?php
	}
			...
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title">Importer des données</h4>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<div class="modal-body">
						<label>Sélectionnez le fichier à importer <input required="required" class="form-control form-control-sm" type="file" name="file" /> </label>
						<small class="text-muted">Types de fichiers pris en charge(csv , json)</small>
